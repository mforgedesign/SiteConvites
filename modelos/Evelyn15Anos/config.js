window.config = {
  ...
  "evento": {
    ...
    "endereco": "Sítio do Meu Pai Rua Marechal Deodoro da Fonseca, Lota 04, Quadra 1, R Mal Deodoro, s/n - Santa Cruz da Serra, Duque de Caxias"
  ...
  // =========================
  "convite": {
    "paletaCores": "Verde, Dourado, Vermelho, Branco",
    // Paleta de cores usada no design do convite

    "tema": "Bosque Fluminense",
