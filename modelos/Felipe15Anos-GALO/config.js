window.config = {
  ...
  "evento": {
    ...
    "endereco": "Alameda Maria Turíbia de Jesus 85, centro, Betim. MG."
  ...
  // =========================
  "convite": {
    "paletaCores": "Preto e Branco (+Verde + Prata)",
    // Paleta de cores usada no design do convite

    "tema": "Galo (Clube Atlético Mineiro)",
