window.config = {
  ...
  "evento": {
    ...
    "nome": "Modelo Floral Minimalista",
    ...
    "endereco": "Avenida Deputado Ulisses Guimarães 385"
  ...
  // =========================
  "convite": {
    "paletaCores": "Azul Royal com Prata e Lilás",
    // Paleta de cores usada no design do convite

    "tema": "Floral Elegante Minimalista",
