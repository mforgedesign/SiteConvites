window.config = {
  ...
  "evento": {
    ...
    "endereco": "R. Istambul, 31 - Bangu, Rio de Janeiro - RJ, 21870-080"
  ...
  // =========================
  "convite": {
    "paletaCores": "Preto, Vermelho e Dourado (+Branco e Preto)",
