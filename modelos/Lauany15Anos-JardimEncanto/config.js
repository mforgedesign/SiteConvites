window.config = {
  ...
  "evento": {
    ...
    "endereco": "Guararapes, 1562 - Parque Guadalajara (Jurema), Caucaia - CE, 61650-050"
  ...
  // =========================
  "convite": {
    "paletaCores": "Fúcsia, tons de roxo, lilás e tons de rosa",
    // Paleta de cores usada no design do convite

    "tema": "Jardim encantado, Quarto da Isabela filme encanto",
    ...
    "slug": "Lauany15Anos-JardimEncanto",
