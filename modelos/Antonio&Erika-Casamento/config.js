window.config = {
  ...
  "evento": {
    ...
    "endereco": "Fried Fish Vilarejo restaurante  R. José Ruíz Pelegrina, 7-55 - Vila Guedes de Azevedo, Bauru - SP"
  ...
  // =========================
  "convite": {
    "paletaCores": "Lilás, Branco, Prata (+Verde +Creme)",
    // Paleta de cores usada no design do convite

    "tema": "Lavanda e Floral",
