...
const segments = {
  decoradores: {
    ...
    description: "Você indica a MForge, nós atendemos o cliente e transformamos o conceito da decoração em uma experiência digital coerente. Cada venda concluída gera créditos para materiais que fortalecem o seu próprio negócio.",
    ...
    rewards: "Use créditos em carrosséis, catálogos, apresentação comercial, landing page e materiais para Instagram.",
  ...
  saloes: {
    ...
    description: "Ofereça convite interativo junto da locação. A MForge assume briefing, criação, ajustes e suporte, enquanto o seu salão ganha um diferencial simples de apresentar e créditos para melhorar sua presença digital.",
    ...
    rewards: "Troque créditos por criativos, catálogo de ambientes, página de orçamento, melhorias no Instagram ou site.",
  ...
  buffets: {
    ...
    rewards: "Resgate cardápios digitais, catálogos, carrosséis, vídeos curtos, landing page ou repaginação visual do Instagram.",
  ...
  cerimonialistas: {
    ...
    description: "Você mantém a estratégia e o relacionamento. A MForge executa o convite, organiza as funções digitais e atende cada produção. As vendas concluídas geram créditos para materiais que ajudam você a fechar novos eventos.",
    ...
    rewards: "Use créditos em propostas, páginas de captação, catálogos, apresentações, criativos e conteúdo para redes sociais.",
  ...
  document.body.innerHTML = `
    ...
    <main id="conteudo">
      <section class="hero"><div class="wrap hero-grid">
        <div><p class="eyebrow" data-segment-label>PROGRAMA DE PARCEIROS</p><h1 data-segment-headline>Uma parceria feita para o seu segmento.</h1><h1><em data-segment-accent>Mais valor sem aumentar a operação.</em></h1><p class="hero-copy" data-segment-description>A MForge cuida da produção e transforma vendas concluídas em créditos para serviços digitais.</p><div class="hero-actions"><a class="button button-primary" data-partner-cta target="_blank" rel="noopener">Quero conhecer o programa</a><a class="button button-secondary" href="#modelos">Ver modelos de convite</a></div><div class="trust-row"><span>Sem comissão em dinheiro</span><span>Atendimento pela MForge</span><span>Créditos acumuláveis</span></div></div>
        <aside class="hero-card"><span class="mini-label">O QUE MUDA PARA VOCÊ</span><h2 data-segment-benefit>Uma oferta mais completa para seu cliente.</h2><p>Você gera a oportunidade e escolhe como apresentá-la. A MForge assume briefing, criação, ajustes e suporte.</p><div class="credit-preview"><div class="credit-line"><span>Pedido quitado</span><strong>+1 crédito</strong></div><div class="credit-line"><span>Produção do convite</span><strong>MForge</strong></div><div class="credit-line"><span>Resgate</span><strong>serviços digitais</strong></div></div></aside>
      </div></section>
      ...
      <section class="section section-soft"><div class="wrap"><header class="section-head"><p class="eyebrow">DOIS JEITOS DE OFERECER</p><h2>Adapte a parceria <em>ao seu processo comercial.</em></h2></header><div class="grid grid-2">
        <article class="card partnership-card"><span class="step">1</span><div><h3>Indicação assistida</h3><p>Apresente a solução e conecte o cliente. A MForge continua a conversa, fecha e entrega.</p><ul><li>Cliente contrata diretamente.</li><li>Você não precisa explicar detalhes técnicos.</li><li>Quitação libera crédito.</li></ul></div></article>
        <article class="card partnership-card"><span class="step">2</span><div><h3>Convite dentro do pacote</h3><p data-segment-bundle>Inclua o convite na sua proposta e deixe toda a execução conosco.</p><ul><li>Você controla a apresentação da oferta.</li><li>Podemos atender o cliente em seu nome ou em conjunto.</li><li>Pedido quitado também gera crédito.</li></ul></div></article>
      </div></div></section>

      <section class="section"><div class="wrap"><header class="section-head"><p class="eyebrow">VALOR PARA O PARCEIRO</p><h2>O retorno vem em <em>estrutura de venda.</em></h2><p data-segment-rewards>Use créditos em criativos, catálogos, páginas e outros ativos digitais.</p></header><div class="grid grid-3"><article class="card"><span class="card-icon">◇</span><h3>Conteúdo</h3><p>Artes, stories, carrosséis e vídeos curtos para campanhas e prova social.</p></article><article class="card"><span class="card-icon">▤</span><h3>Materiais comerciais</h3><p>Catálogos, apresentações, propostas e peças para vender pacotes com clareza.</p></article><article class="card"><span class="card-icon">↗</span><h3>Presença digital</h3><p>Landing pages, sites e organização visual para captar e converter mais contatos.</p></article></div></div></section>
      ...
      <section class="section" id="como-funciona"><div class="wrap"><header class="section-head"><p class="eyebrow">OPERAÇÃO SIMPLES</p><h2>Você apresenta. <em>A MForge executa.</em></h2></header><div class="grid grid-4 process"><article class="card"><h3>Código do parceiro</h3><p>Criamos sua identificação e definimos o modelo de oferta.</p></article><article class="card"><h3>Cliente sinalizado</h3><p>O contato chega com seu código ou é enviado por você.</p></article><article class="card"><h3>Produção completa</h3><p>Briefing, criação, ajustes, entrega e suporte ficam conosco.</p></article><article class="card"><h3>Crédito liberado</h3><p>Após a quitação, você escolhe acumular ou resgatar.</p></article></div></div></section>

      <section class="section section-soft"><div class="wrap"><header class="section-head"><p class="eyebrow">DÚVIDAS FREQUENTES</p><h2>Regras claras <em>desde o início.</em></h2></header><div class="faq"><details><summary>Quando o crédito é liberado?</summary><p>Depois que o convite indicado estiver integralmente pago. Orçamentos, sinais cancelados ou pedidos reembolsados não geram crédito.</p></details><details><summary>Os créditos viram dinheiro?</summary><p>Não. Eles são exclusivos para serviços digitais do catálogo MForge e podem ser acumulados por até seis meses.</p></details><details><summary>Quem atende o cliente?</summary><p>A MForge pode assumir todo o atendimento ou trabalhar em conjunto, conforme o modelo definido no cadastro do parceiro.</p></details><details><summary>Posso incluir o convite no meu pacote?</summary><p>Sim. Você incorpora o valor na própria proposta e a MForge executa o pedido conforme o briefing acordado.</p></details></div></div></section>
